...
# - Si el número es divisible por 5, mostrar dicho número en pantalla (¡recuerda que aquí
# puedes utilizar la operación módulo dividiendo por 5 y verificando el resto!)
